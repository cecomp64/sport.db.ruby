...
Gem::Specification.new do |s|
  ...
  all_files.each do |f|
    s.files << f.split('sport.db.ruby/')[1]
  end

  s.homepage = "https://github.com/cecomp64/sport.db.ruby"
  ...
  s.test_files = ["test/test_date.rb", "test/test_lang.rb", "test/test_load.rb", "test/test_cursor.rb", "test/test_standings.rb", "test/test_scores.rb", "test/test_winner.rb", "test/test_round_def.rb", "test/test_utils.rb", "test/test_round_header.rb", "test/test_round_auto.rb", "test/test_reader.rb", "test/test_changes.rb"]
